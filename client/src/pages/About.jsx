...
import Albums from '../components/albums-photos/Albums'
  ...
  return (
    <div className='about'>
      ...
      <img className='aproposdeImg' src={AproposDe} alt=""/>
        ...
        <p> Mon approche de l’éducation canine est basée sur le respect mutuel, la confiance, et l’adhésion de l’animal.
          Ma compréhension du comportement du chien me permet d’établir une complicité propice à l’éducation et à l’apprentissage.
          C’est au quotidien que je constate personnellement toute la valeur et l’efficacité de la méthode que j’utilise, et ce, sur mes propres chiens.
          Malgré leur passé difficile et parfois atroce, ils cohabitent sereinement et en parfaite harmonie.
          Spécialiste des chiens de  refuge, je peux vous apporter mon aide pour trouver un bel équilibre. </p>
        <p> C’est donc un réel engagement pour moi que de partager ma passion avec ceux qui cherchent le bien être de leur plus fidèle compagnon.
